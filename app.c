...
st_led_param_t red = {
    ...
    RED,
    100};
// 100ms para o LED Vermelho (acender e apagar a cada numero digitado)


TaskHandle_t greenTask_blinking_hdlr, greenTask_off_hdlr, redTask_blink_hdlr, redTask_off_hdlr, redTask_on_hdlr;
...
static void prvTask_getChar(void *pvParameters)
{
    ...
    // Entrada dos comandos do teclado (numeros e caracteres)
        switch (key)
        {
        case '+':
